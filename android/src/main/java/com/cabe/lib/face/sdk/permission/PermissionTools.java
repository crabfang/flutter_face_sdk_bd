...
public class PermissionTools {
    ...
    private PermissionTools(Context context,
        ...
        if (mHintRequestID == -1) {
            mHintRequestID = R.string.app_name;
        }

        if (mHintNeverAskID == -1) {
            mHintNeverAskID = R.string.app_name;
        }
        ...
        if (mPositiveBtnIDForNeverAsk == -1) mPositiveBtnIDForNeverAsk = R.string.app_name;
